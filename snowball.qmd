...
on.exit(
    {
        unlink(gdm_path, recursive = TRUE)
    }   
)
    ...
    function(name) {
        ...
        map <- sapply(
            ...
            IPBES.R::map_country_codes(
                values = "log_n_1",
                geodata_path = gdm_path
            ) +
            ggplot2::ggtitle(paste(name, "First Author Only"))

        if (length(list.files("figures", pattern = paste0(plot_name, ".*(pdf|png)"))) < 2) {
            ggplot2::ggsave(
                file.path("figures", paste0(plot_name, ".pdf")),
                map,
                width = 5,
                height = 2.5
            )
            ggplot2::ggsave(
                file.path("figures", paste0(plot_name, ".png")),
                map,
                width = 5,
                height = 2.5
            )
...
![](figures/map_first_author__S1.png)

#### All Authors no weighting

![](figures/map_all_authors__S1.png)

### Cluster 1

![](figures/map_first_author_cluster_1__S1.png)

![](figures/cluster_1_S1_cited_by_count_by_year.png)

- [Better quality map](figures/map_first_author_cluster_1__S1.pdf){target=_blank}
...
![](figures/map_first_author_cluster_2__S1.png)

![](figures/cluster_2_S1_cited_by_count_by_year.png)

- [Better quality map](figures/map_first_author_cluster_2__S1.pdf){target=_blank}
...
![](figures/map_first_author_cluster_3__S1.png)

![](figures/cluster_3_S1_cited_by_count_by_year.png)

- [Better quality map](figures/map_first_author_cluster_3__S1.pdf){target=_blank}
...
![](figures/map_first_author_cluster_4__S1.png)

![](figures/cluster_4_S1_cited_by_count_by_year.png)

- [Better quality map](figures/map_first_author_cluster_4__S1.pdf){target=_blank}
...
!![](figures/map_first_author_cluster_5__S1.png)

[](figures/cluster_5_S1_cited_by_count_by_year.png)

- [Better quality map](figures/map_first_author_cluster_5__S1.pdf){target=_blank}
...
![](figures/map_first_author_cluster_6__S1.png)

![](figures/cluster_6_S1_cited_by_count_by_year.png)

- [Better quality map](figures/map_first_author_cluster_6__S1.pdf){target=_blank}
